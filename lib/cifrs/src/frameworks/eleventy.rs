...
use crate::js_module::{get_assignment_function, get_function_return_obj, get_obj_property, get_string_property_value};
...
mod tests {
    ...
    fn test_eleventy() {
        let eleventy = Eleventy::new(
            Some(vec!["tests/fixtures/framework_configs/eleventy/.eleventy.js"])
        );
